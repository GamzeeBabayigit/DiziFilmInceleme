...
<body style="background-color: #ffffff;">
	...
	<form class="login"  action="" method="POST">
		  ...
		  <button>Login</button>
		  <div>
		    <a href="kayit.jsp" class="btn" style="position: absolute; right: 10px; bottom: 50px;">KAYIT OL</a>
	 <br>
		 <a style="color: black; bottom: 13px;right: auto;" href="forgetpassword.jsp">Forg	et password !</a>
		 </div>
		  </form>

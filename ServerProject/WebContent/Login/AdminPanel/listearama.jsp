...
<%
		...
		if(kontrol == "0"){
			...
			if(request.getParameter("deleteUserID") != null){  
				...
				response.sendRedirect("listearama.jsp");
				return;
			}
...
<body id="page-top">
                  ...
                  <div class="table-responsive" id="tab3">
                    ...
                    <th> </th>
                  	...
                  	for (login value : users) {
                  		...
                  		tut += "<td><a href='elemanduzenle.jsp?id="+ String.valueOf(value.getId())+"' class='btn btn-primary'>Düzenle</a>&nbsp;<button type='button' onclick='deleteUpdate("+String.valueOf(value.getId())+")' class='btn btn-danger' data-toggle='modal' data-target='#deleteModal'>Sil</button></td>";
                  	    out.println(tut);
                  	    i++;
                  	}
                  	%>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Kullanıcı Silme İşlemi</h5>

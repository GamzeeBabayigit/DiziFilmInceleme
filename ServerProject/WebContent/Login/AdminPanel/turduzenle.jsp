...
if(request.getParameter("id") == null){  
	...
	db.start();
	tur = db.getTur(Integer.parseInt(request.getParameter("id")));
	if(tur == null){
		response.sendRedirect("turlistele.jsp");
		return;
	}
	if(request.getParameter("TurAdi") !=null){
		tur.setTurAdi(request.getParameter("TurAdi"));
		boolean result = db.updateTur(tur);
		if(result != false){
			out.print("<script>alert('Tur Başarıyla Düzenlendi.')</script>");
			response.sendRedirect("turlistele.jsp");
			return;
           ...
           <%=username%><br>
				...
				<div class="card-body">
                  ...
                  <form action="" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Tur Adi</label>
                          <input name="TurAdi" type="text" id="TurAdi" type="text" class="form-control" value="<%=tur.getTurAdi()%>" required="required">
                        </div>
                      </div>
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Tur Düzenle</button>

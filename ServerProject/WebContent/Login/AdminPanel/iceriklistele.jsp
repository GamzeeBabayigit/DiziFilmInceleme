...
if(kontrol == "0"){
	...
	if(request.getParameter("deleteUserID") != null){  
		...
		icerik dicerik = db.geticerik(deleteId);
		if(dicerik !=null){
			db.deleteicerik(dicerik);
		}
                  ...
                  <div class="table-responsive" id="tab3">
                    ...
                    <th> </th>
                      ...
                      <tbody>
                       <%
                  	int i=1;
                  	for (icerik value : icerik) {
                  		String tut = "<tr>";
                  		tut += "<td>"+ String.valueOf(i)+"</td>";
                  		tut += "<td>"+ value.getBaslik()+"</td>";
                  		tut += "<td>"+ value.geticerik()+"</td>";
                  		tut += "<td>"+ value.getYapimYili()+"</td>";
                  		tut += "<td>"+ value.getOyuncular()+"</td>";
                  		tut += "<td>"+ value.getTur()+"</td>";
                  		tut += "<td>"+ value.getKategori()+"</td>";
                  		tut += "<td>"+ value.getGorsel()+"</td>";
                  		tut += "<td>"+ value.getYazar()+"</td>";
                  		tut += "<td>"+ value.getId()+"</td>";
                  		tut += "<td><a href='icerikduzenle.jsp?id="+ String.valueOf(value.getId())+"' class='btn btn-primary'>Düzenle</a>&nbsp;<button type='button' onclick='deleteUpdate("+String.valueOf(value.getId())+")' class='btn btn-danger' data-toggle='modal' data-target='#deleteModal'>Sil</button></td>";
                  	    out.println(tut);
                  	    i++;
                  	}
                  	%>
...
function deleteUpdate(data){
 ...
 <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">İçerik Silme İslemi</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Kapat">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        İçeriği Silmek İstediginize Emin misiniz?
      </div>
      <div class="modal-footer">

                  ...
                  <div class="table-responsive" id="tab3">
                    <table class="table">
                  	...
                  	for (duyuru value : duyuru) {
                  		...
                  		tut += "<td><a href='duyuruduzenle.jsp?id="+ String.valueOf(value.getId())+"' class='btn btn-primary'>Düzenle</a>&nbsp;<button type='button' onclick='deleteUpdate("+String.valueOf(value.getId())+")' class='btn btn-danger' data-toggle='modal' data-target='#deleteModal'>Sil</button></td>";
                  	    out.println(tut);
                  	    i++;
                  	}
                  	%>
...
function deleteUpdate(data){
 ...
 <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Duyuru Silme İşlemi</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Kapat">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Duyuruyu Silmek İstediginize Emin misiniz?
      </div>
      <div class="modal-footer">

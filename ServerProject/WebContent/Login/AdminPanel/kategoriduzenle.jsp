...
if(request.getParameter("id") == null){  
	...
	db.start();
	kategori = db.getKategori(Integer.parseInt(request.getParameter("id")));
	if(kategori == null){
		response.sendRedirect("kategorilistele.jsp");
		return;
	}
	if(request.getParameter("KategoriAdi") !=null){
		kategori.setKategoriAdi(request.getParameter("KategoriAdi"));
		boolean result = db.updateKategori(kategori);
		if(result != false){
			out.print("<script>alert('Kategori Başarıyla Düzenlendi.')</script>");
			response.sendRedirect("kategorilistele.jsp");
			return;
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input name="KategoriAdi" type="text" id="KategoriAdi" type="text" class="form-control" value="<%=kategori.getKategoriAdi()%>" required="required">
                        </div>
                      </div>

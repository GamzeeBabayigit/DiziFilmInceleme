...
<%@ page language="java" contentType="text/html; charset=UTF-8"%>
	...
	<jsp:useBean id="tur" class="first.kategori"/> 
<%
...
if(request.getParameter("KategoriAdi") != null){
	...
	tur.setKategoriAdi(request.getParameter("KategoriAdi"));
	db.start();
	boolean result = db.insertKategori(tur);
	if(result != false){
		out.print("<script>alert('Kategori Başarıyla Oluşturuldu.')</script>");
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input name="KategoriAdi" type="text" id="KategoriAdi" type="text" class="form-control" required="required">
                        </div>
                      </div>

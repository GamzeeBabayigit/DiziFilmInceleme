...
String forsearch = (request.getParameter("loginara"));
if(forsearch != null){
	users =db.loginara(forsearch);}
 
	  
//String deleteId1 = (request.getParameter("elemanara"));

//String select2[] = request.getParameterValues("idi"); 
// if (select2 != null && select2.length != 0) {

//for (int i = 0; i < select2.length; i++) {

//	if(select2[i].equals("adak")){
//		users =db.elemanara(deleteId1);
//		 System.out.print("ARA");
//	}
//	else
//	{
//		users =db.elemansoyad(deleteId1);
//	}
//}
//}
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form method="post" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            ...
                            <input type="text" id="loginara" name="loginara" class="form-control bg-light border-0 small" placeholder="Search for..."
                  ...
                  <div class="table-responsive" id="tab3">
                    ...
                    <th> </th>
                      ...
                      <tbody>
                       <%
                  	int i=1;
                  	for (login value : users) {
                  		String tut = "<tr>";
                  		tut += "<td>"+ String.valueOf(i)+"</td>";
                  		tut += "<td>"+ value.getEmail()+"</td>";
                  		tut += "<td>"+ value.getPass()+"</td>";
 
                  		tut += "<td>"+ value.getId()+"</td>";
                  		tut += "<td><a href='elemanduzenle.jsp?id="+ String.valueOf(value.getId())+"' class='btn btn-success'>Düzenle</a>&nbsp;<a href='sendMail.jsp?id="+ String.valueOf(value.getId())+"' class='btn btn-primary'>Mail Gönder</a>&nbsp;<button type='button' onclick='deleteUpdate("+String.valueOf(value.getId())+")' class='btn btn-danger' data-toggle='modal' data-target='#deleteModal'>Sil</button></td>";
                  	    out.println(tut);
                  	    i++;
	                  	}
	                  	%>
...
function deleteUpdate(data){
 ...
 <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Kullanici Silme İslemi</h5>

...
if(kontrol == "0"){
	...
	if(request.getParameter("deleteUserID") != null){  
		...
		kategori dkategori = db.getKategori(deleteId);
		if(dkategori !=null){
			db.deleteKategori(dkategori);
		}
	...
	List<kategori> kategori = db.listAllKategoris();
	 
	String forsearch = (request.getParameter("kategoriara"));
	if(forsearch != null){
		kategori =db.kategoriara(forsearch);}
%>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                 ...
                 <form method="post" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            ...
                            <input type="text" id="kategoriara" name="kategoriara" class="form-control bg-light border-0 small" placeholder="Search for..."
                  ...
                  <div class="table-responsive" id="tab3">
                    ...
                    <th> </th>
                      ...
                      <tbody>
                       <%
                  	int i=1;
                  	for (kategori value : kategori) {
                  		String tut = "<tr>";
                  		tut += "<td>"+ String.valueOf(i)+"</td>";
                  		tut += "<td>"+ value.getKategoriAdi()+"</td>";
                  
                   
                  		tut += "<td><a href='kategoriduzenle.jsp?id="+ String.valueOf(value.getId())+"' class='btn btn-primary'>Düzenle</a>&nbsp;<button type='button' onclick='deleteUpdate("+String.valueOf(value.getId())+")' class='btn btn-danger' data-toggle='modal' data-target='#deleteModal'>Sil</button></td>";
                  	    out.println(tut);
                  	    i++;
                  	}
                  	%>
...
function deleteUpdate(data){
 ...
 <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Kategori Silme İslemi</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Kapat">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Kategoriyi Silmek İstediginize Emin misiniz?
      </div>
      <div class="modal-footer">

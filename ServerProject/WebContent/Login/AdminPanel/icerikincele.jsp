...
if(request.getParameter("id") == null){  
	...
	if(request.getParameter("Baslik") !=null){
		...
		boolean result = db.updateicerik(icerik);
		if(result != false){
			out.print("<script>alert('İçerik Başarıyla Düzenlendi.')</script>");
			response.sendRedirect("iceriklistele.jsp");
			return;
   ...
   <% String username = (String) session.getAttribute("username"); %>
           <%=username%><br>
				...
				<div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input name="Baslik" type="text" id="Baslik" type="text" class="form-control" placeholder="Başlık" value="<%=icerik.getBaslik()%>" required="required">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">İçerik</label>
	              			<input name="icerik" type="text" id="icerik" class="form-control" placeholder="icerik" value="<%=icerik.geticerik()%>" required="required">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                  ...
                  <input name="YapimYili" type="text" id="YapimYili" class="form-control" placeholder="YapimYili" value="<%=icerik.getYapimYili()%>" required="required">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Oyuncular</label>
	              <input name="Oyuncular" type="text" id="Oyuncular" class="form-control" placeholder="Oyuncular" value="<%=icerik.getOyuncular()%>" required="required" onkeypress='return event.charCode>= 48 &&event.charCode<= 57'>
                        </div>
                      </div>
                  ...
                  <input name="Tur" type="text" id="Tur" class="form-control" placeholder="Tur" value="<%=icerik.getTur()%>" required="required">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Kategori</label>
	              <input name="Kategori" type="text" id="Kategori" class="form-control" placeholder="Kategori" value="<%=icerik.getKategori()%>" required="required" onkeypress='return event.charCode>= 48 &&event.charCode<= 57'>
                        </div>
                      </div>
                  ...
                  <input name="Gorsel" type="text" id="Gorsel" class="form-control" placeholder="Video" value="<%=icerik.getGorsel()%>" required="required">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Yazar</label>
	              <input name="Yazar" type="Text" id="Yazar" class="form-control" placeholder="Yazar" value="<%=icerik.getYazar()%>" required="required" onkeypress='return event.charCode>= 48 &&event.charCode<= 57'>
                        </div>
                      </div>
                    ...
                    <button type="submit" class="btn btn-primary pull-right">İçerik Düzenle</button>

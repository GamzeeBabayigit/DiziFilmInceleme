	...
	if(dUser ==null){
		if(request.getParameter("psw")!=null ){
			...
			if(request.getParameter("psw").length()<6){
				response.sendRedirect("elemanekle.jsp");	
			}
			else
			{
				db.start();
           ...
           <%=username%><br>
                ...
                <div class="container-fluid">
         		...
         		<form action="" method="POST">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input name="psw" type="text" id="psw" type="text" class="form-control" required="required">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Email address</label>
                          <input name="usrname" type="email" id="usrname" class="form-control" required="required">
                        </div>
                      </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Elemanı Ekle</button>

...
<%@ page language="java" contentType="text/html; charset=UTF-8"%>
	...
	<jsp:useBean id="tur" class="first.tur"/> 
<%
...
if(request.getParameter("TurAdi") != null){
	...
	db.start();
	boolean result = db.insertTur(tur);
	if(result != false){
		out.print("<script>alert('Tur Başarıyla Oluşturuldu.')</script>");
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input name="TurAdi" type="text" id="TurAdi" type="text" class="form-control" required="required">
                        </div>
                      </div>
                       
                    </div>
                     
                    <button type="submit" class="btn btn-primary pull-right">Tur Ekle</button>

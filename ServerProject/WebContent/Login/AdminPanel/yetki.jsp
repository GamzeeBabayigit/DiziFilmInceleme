...
if(request.getParameter("deleteUserID1") != null){  
	String deleteIda1 = (request.getParameter("deleteUserID1"));
	
	login dUser11 =db.getkayit(deleteIda1);
	if(dUser11 !=null){
		//System.out.print(deleteIda);
		db.yetkiupdate1(dUser11); 
...
<body id="page-top">
   ...
   <% String username = (String) session.getAttribute("username"); %>
           <%=username%><br>
              ...
              <p class="card-category">Kullanıcı Listesi</p>
                  ...
                  <div class="table-responsive" id="tab3">
                    ...
                    <th> </th>
                  	...
                  	for (login value : yetki) {
                  		...
                  		tut += "<td>"+ value.getyetki()+"</td>";
                  		tut += "<td><button type='button' onclick='deleteUpdate1("+(value.getId())+")' class='btn btn-danger' data-toggle='modal' data-target='#deleteModal1'>YETKİ AL</button></td><td><button type='button' onclick='deleteUpdate("+(value.getId())+")' class='btn btn-primary' data-toggle='modal' data-target='#deleteModal'>YETKİ VER</button></td>";

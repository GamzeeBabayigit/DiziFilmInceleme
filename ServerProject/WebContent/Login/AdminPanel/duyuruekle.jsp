...
<jsp:useBean id="duyuru" class="first.duyuru"/> 
...
if(request.getParameter("Baslik") != null){
	...
	String timeIs = dtf.format(now);
	duyuru.setBaslik(request.getParameter("Baslik"));
	duyuru.seticerik(request.getParameter("icerik"));
	duyuru.setdate(timeIs);
	db.start();
	boolean result = db.insertDuyuru(duyuru);
	if(result != false){
		out.print("<script>alert('Duyuru Başarıyla Oluşturuldu.')</script>");
                ...
                <div class="container-fluid">
                       ...
                       <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Duyuru Ekle</h6>
                                </div>
                                <div class="card-body">
         		...
         		<form action="" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary pull-right">İçerik Ekle</button>

...
if(request.getParameter("id") == null){  
	response.sendRedirect("listeleme.jsp");
	return;
}else{
	db.start();
	...
	if(request.getParameter("email") !=null){
		...
		if(result != false){
			out.print("<script>alert('Kullanıcı Başarıyla Düzenlendi.')</script>");
           ...
           <%=username%><br>
				...
				<div class="card-body">
                  ...
                  <form action="" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input name="email" type="text" id="email" type="text" class="form-control" value="<%=user.getEmail()%>" required="required">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Password</label>
	              			<input name="pass" type="text" id="pass" class="form-control" placeholder="E-Posta" value="<%=user.getPass()%>" required="required">
                        </div>
                      </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Elemanı Düzenle</button>
